...
export const metadata: Metadata = {
  title: "Areas We Serve | Website & App Development | TNWebz",
  description:
    "Explore the locations served by TNWebz across Chennai, Tambaram, Guindy, Kanchipuram, Sriperumbudur, and surrounding regions. Find local web design and app development services near you.",
  alternates: {
    canonical: "https://tnwebz.com/locations",
  },
  openGraph: {
    title: "Areas We Serve | TNWebz",
    description:
      "Explore the locations served by TNWebz across Chennai and surrounding suburbs.",
    url: "https://tnwebz.com/locations",
    siteName: "TNWebz",
    locale: "en_IN",
    type: "website",
  },
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Locations", url: "https://tnwebz.com/locations" },
]);
    ...
    <main className="min-h-screen bg-[#f5f5f3]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 pt-28 md:pt-36">
        <nav aria-label="Breadcrumb" className="text-sm text-zinc-500 mb-8">
          <ol className="flex items-center gap-2">
            ...
            <li className="text-zinc-900 font-medium">Locations</li>
          </ol>
        </nav>
      </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-8 pb-16">
        ...
        <p className="text-lg text-zinc-600 max-w-2xl leading-relaxed">
          We provide high-quality website development, e-commerce stores, custom web applications, and mobile app development for businesses across Chennai and surrounding municipal zones. Find your area below to learn more about our local services.
        </p>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-8 py-20 border-t border-zinc-200/60 text-center">
        <h2 className="text-3xl md:text-4xl font-medium text-zinc-900 mb-4">
          Serving All of Chennai and Surrounds
        </h2>
        <p className="text-zinc-600 max-w-lg mx-auto mb-8">
          Don&apos;t see your specific location? We still serve your area! Get in touch with us to discuss your digital requirements.
        </p>
        <a
